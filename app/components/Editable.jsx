...
export default class Editable extends React.Component {
  ...
  renderEdit = () => {
    ...
    // It gets triggered after the componenet is mounted.
    //
    ...
    return <input type="text" ref={ (e) => e ? e.selectionStart = this.props.value.length : null }
      autoFocus={true}
  ...
  finishEdit = (e) => {
    ...
    // has a new value. We will use this to communicate the chnage to
    // 'App'.
    //
